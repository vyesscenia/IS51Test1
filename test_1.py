...
"""
The program is trying to determin which payment is better (more money).
Firtst option is 100 dollars per day for 10 days. The second option is 1 dollar
a day with it being doubled each day for 10 days. There will be two functions to calculate the pay rate.
function will calculate the amount for thefirst option, function2 will calculate the amount for the second options.
...
if the amount is equal, we output to the user "Option 2 pays the same"
